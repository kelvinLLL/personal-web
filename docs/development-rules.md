...
- When a backend JSON store contains private user-authored content, keep the generated data file gitignored and let the service create its empty local store on demand.
